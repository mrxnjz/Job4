...
/**
 * /jobquests — opens the Quest Management GUI.
 * Aliases: /jq
 */
public class JobQuestsCommand implements CommandExecutor, TabCompleter {

    private final EnhancedJobsPlugin plugin;

    public JobQuestsCommand(EnhancedJobsPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (data.getJobIds().isEmpty()) {
            MessageUtil.send(player, "You haven't joined any jobs yet! Use &e/job&r to get started.");
            return true;
        }
